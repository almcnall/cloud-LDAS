...
follow the steps described in that folder's README.
...
using the bash kernel for code cells.
...
With the [Jupytext] extension to JupyterLab installed, execution of MyST Markdown code cells is like execution of Notebook code cells.
